...
IGL_INLINE void igl::cotmatrix_intrinsic(const Eigen::MatrixBase<Derivedl> &l,
...
template void
igl::cotmatrix_intrinsic<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
...
template void
igl::cotmatrix_intrinsic<Eigen::Matrix<double, -1, -1, 1, -1, -1>,
                         Eigen::Matrix<int, -1, -1, 0, -1, -1>, double>(
...
igl::cotmatrix_intrinsic<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    ...
    Eigen::SparseMatrix<double, 0, int> &);
template void
igl::cotmatrix_intrinsic<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                         Eigen::Matrix<int, -1, -1, 0, -1, -1>, double>(
