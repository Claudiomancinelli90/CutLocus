...
template <typename DerivedT, typename DerivedF, typename DerivedJ,
          typename DerivedK>
IGL_INLINE void igl::boundary_facets(const Eigen::MatrixBase<DerivedT> &T,
...
IGL_INLINE void
igl::boundary_facets(const std::vector<std::vector<IntegerT>> &T,
  ...
  vector<vector<IntegerF>> allF(T.size() * simplex_size,
...
template void igl::boundary_facets<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                   Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
// generated by autoexplicit.sh
template void
igl::boundary_facets<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
...
template void igl::boundary_facets<int, int>(
    std::vector<std::vector<int, std::allocator<int>>,
                std::allocator<std::vector<int, std::allocator<int>>>> const &,
    std::vector<std::vector<int, std::allocator<int>>,
                std::allocator<std::vector<int, std::allocator<int>>>> &);
// template Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1> >
// igl::boundary_facets(Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1,
// -1> > const&);
